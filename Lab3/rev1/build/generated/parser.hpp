...
/**
 ** \file /mnt/c/Users/soul8/Theory Automata/Lab3/rev1/build/generated/parser.hpp
...
#ifndef YY_YY_MNT_C_USERS_SOUL8_THEORY_AUTOMATA_LAB3_REV1_BUILD_GENERATED_PARSER_HPP_INCLUDED
# define YY_YY_MNT_C_USERS_SOUL8_THEORY_AUTOMATA_LAB3_REV1_BUILD_GENERATED_PARSER_HPP_INCLUDED
// "%code requires" blocks.
#line 10 "/mnt/c/Users/soul8/Theory Automata/Lab3/rev1/src/parser.y"
...
#line 58 "/mnt/c/Users/soul8/Theory Automata/Lab3/rev1/build/generated/parser.hpp"
...
namespace yy {
#line 198 "/mnt/c/Users/soul8/Theory Automata/Lab3/rev1/build/generated/parser.hpp"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // opt_elements
      // elements
      char dummy4[sizeof (std::vector<AST_TYPE>)];
    };
    ...
    TOK_IF = 5,                    // IF
    TOK_ELSE = 6,                  // ELSE
    TOK_TYPECHECK = 7,             // TYPECHECK
    TOK_SIZE = 8,                  // SIZE
    TOK_LOOP = 9,                  // LOOP
    TOK_WHILE = 10,                // WHILE
    TOK_PRINT = 11,                // PRINT
    TOK_FUNCTION = 12,             // FUNCTION
    TOK_TYPE_INTEGER = 13,         // "integer"
    TOK_TYPE_BOOLEAN = 14,         // "boolean"
    TOK_TYPE_CUBE = 15,            // "cube"
    TOK_TYPE_MASSIVE = 16,         // "massive"
    TOK_TYPE_VOID = 17,            // "void"
    TOK_EQUAL = 18,                // "="
    TOK_DEQUAL = 19,               // "=="
    TOK_NEQUAL = 20,               // "~="
    TOK_ACCESS = 21,               // "=>"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_IF = 5,                                // IF
        S_ELSE = 6,                              // ELSE
        S_TYPECHECK = 7,                         // TYPECHECK
        S_SIZE = 8,                              // SIZE
        S_LOOP = 9,                              // LOOP
        S_WHILE = 10,                            // WHILE
        S_PRINT = 11,                            // PRINT
        S_FUNCTION = 12,                         // FUNCTION
        S_TYPE_INTEGER = 13,                     // "integer"
        S_TYPE_BOOLEAN = 14,                     // "boolean"
        S_TYPE_CUBE = 15,                        // "cube"
        S_TYPE_MASSIVE = 16,                     // "massive"
        S_TYPE_VOID = 17,                        // "void"
        S_EQUAL = 18,                            // "="
        S_DEQUAL = 19,                           // "=="
        S_NEQUAL = 20,                           // "~="
        ...
        S_boolean = 59,                          // boolean
        S_expr = 60,                             // expr
        S_control_sequence = 61,                 // control_sequence
        S_control = 62,                          // control
        S_type_or_expr = 63,                     // type_or_expr
        S_opt_elements = 64,                     // opt_elements
        S_elements = 65,                         // elements
        S_stmt = 66,                             // stmt
        S_opt_arguments = 67,                    // opt_arguments
        S_arguments = 68,                        // arguments
        S_stmts = 69                             // stmts
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_elements: // elements
        value.move< std::vector<AST_TYPE> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<AST_TYPE>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<AST_TYPE>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_opt_elements: // opt_elements
      case symbol_kind::S_elements: // elements
        value.template destroy< std::vector<AST_TYPE> > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::TOK_YYEOF
                   || (token::TOK_YYerror <= tok && tok <= token::TOK_CHCK)
                   || tok == token::TOK_UNARY);
#endif
      }
#if 201103L <= YY_CPLUSPLUS
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_TYPECHECK (location_type l)
      {
        return symbol_type (token::TOK_TYPECHECK, std::move (l));
      }
#else
      static
      symbol_type
      make_TYPECHECK (const location_type& l)
      {
        return symbol_type (token::TOK_TYPECHECK, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_TYPE_INTEGER (location_type l)
      {
        return symbol_type (token::TOK_TYPE_INTEGER, std::move (l));
      }
#else
      static
      symbol_type
      make_TYPE_INTEGER (const location_type& l)
      {
        return symbol_type (token::TOK_TYPE_INTEGER, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_TYPE_BOOLEAN, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_TYPE_BOOLEAN, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_TYPE_CUBE (location_type l)
      {
        return symbol_type (token::TOK_TYPE_CUBE, std::move (l));
      }
#else
      static
      symbol_type
      make_TYPE_CUBE (const location_type& l)
      {
        return symbol_type (token::TOK_TYPE_CUBE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_TYPE_MASSIVE (location_type l)
      {
        return symbol_type (token::TOK_TYPE_MASSIVE, std::move (l));
      }
#else
      static
      symbol_type
      make_TYPE_MASSIVE (const location_type& l)
      {
        return symbol_type (token::TOK_TYPE_MASSIVE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_DEQUAL (location_type l)
      {
        return symbol_type (token::TOK_DEQUAL, std::move (l));
      }
#else
      static
      symbol_type
      make_DEQUAL (const location_type& l)
      {
        return symbol_type (token::TOK_DEQUAL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_ACCESS, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_ACCESS, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_MFWD (location_type l)
      {
        return symbol_type (token::TOK_MFWD, std::move (l));
      }
#else
      static
      symbol_type
      make_MFWD (const location_type& l)
      {
        return symbol_type (token::TOK_MFWD, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_MBWD (location_type l)
      {
        return symbol_type (token::TOK_MBWD, std::move (l));
      }
#else
      static
      symbol_type
      make_MBWD (const location_type& l)
      {
        return symbol_type (token::TOK_MBWD, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_MLFT (location_type l)
      {
        return symbol_type (token::TOK_MLFT, std::move (l));
      }
#else
      static
      symbol_type
      make_MLFT (const location_type& l)
      {
        return symbol_type (token::TOK_MLFT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_MRGT (location_type l)
      {
        return symbol_type (token::TOK_MRGT, std::move (l));
      }
#else
      static
      symbol_type
      make_MRGT (const location_type& l)
      {
        return symbol_type (token::TOK_MRGT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_LFWD (location_type l)
      {
        return symbol_type (token::TOK_LFWD, std::move (l));
      }
#else
      static
      symbol_type
      make_LFWD (const location_type& l)
      {
        return symbol_type (token::TOK_LFWD, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_LBWD (location_type l)
      {
        return symbol_type (token::TOK_LBWD, std::move (l));
      }
#else
      static
      symbol_type
      make_LBWD (const location_type& l)
      {
        return symbol_type (token::TOK_LBWD, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_LLFT (location_type l)
      {
        return symbol_type (token::TOK_LLFT, std::move (l));
      }
#else
      static
      symbol_type
      make_LLFT (const location_type& l)
      {
        return symbol_type (token::TOK_LLFT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_LRGT (location_type l)
      {
        return symbol_type (token::TOK_LRGT, std::move (l));
      }
#else
      static
      symbol_type
      make_LRGT (const location_type& l)
      {
        return symbol_type (token::TOK_LRGT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_CHCK (location_type l)
      {
        return symbol_type (token::TOK_CHCK, std::move (l));
      }
#else
      static
      symbol_type
      make_CHCK (const location_type& l)
      {
        return symbol_type (token::TOK_CHCK, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_opt_elements: // opt_elements
      case symbol_kind::S_elements: // elements
        value.copy< std::vector<AST_TYPE> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_opt_elements: // opt_elements
      case symbol_kind::S_elements: // elements
        value.move< std::vector<AST_TYPE> > (YY_MOVE (s.value));
        break;
...
#line 2334 "/mnt/c/Users/soul8/Theory Automata/Lab3/rev1/build/generated/parser.hpp"




#endif // !YY_YY_MNT_C_USERS_SOUL8_THEORY_AUTOMATA_LAB3_REV1_BUILD_GENERATED_PARSER_HPP_INCLUDED
